...
## The carry: the arm hangs, the wrist angles the rusty blade down and back so
## its point drags just above the dirt. It lifts from here into every cut.
const CARRY_ARM := Vector3(-4.0, 0.0, 7.0)
const CARRY_HAND := Vector3(-32.0, 0.0, 5.0)
