...
## (Was -40 on the elbow — that slung the whole blade out BEHIND him like a
## tail; -14 keeps it at his side where a carry belongs.)
const CARRY_ARM := Vector3(-4.0, 0.0, 8.0)
const CARRY_HAND := Vector3(-14.0, 0.0, 6.0)
